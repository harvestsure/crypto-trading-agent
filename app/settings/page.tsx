                ...
                <Card className="border-warning/50 bg-warning/5">
                  <CardContent className="p-4">
                    <p className="text-sm text-warning">
                      <strong>Demo Mode:</strong> The app is running without a backend connection. To enable live
                      trading, run the Python backend server and configure the connection below.
                    </p>
                  </CardContent>
                </Card>
